...
import { resolveCustomBaseUrl, IMAGES_GENERATIONS_PATH } from "./_base.js";
...
export default function createOpenAIAdapter(providerId) {
  ...
  return {
    ...
    buildUrl: (model, creds) => resolveCustomBaseUrl(imageUrl(providerId), IMAGES_GENERATIONS_PATH, creds),
    buildHeaders: (creds) => {
