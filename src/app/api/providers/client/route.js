...
import { USAGE_APIKEY_PROVIDERS, USAGE_SUPPORTED_PROVIDERS, APIKEY_USAGE_ENABLED_PROVIDERS } from "@/shared/constants/providers";
...
function isUsageEligible(connection) {
  return USAGE_SUPPORTED_PROVIDERS.includes(connection.provider) && (
    ...
    APIKEY_USAGE_ENABLED_PROVIDERS.includes(connection.provider)
  );
}
